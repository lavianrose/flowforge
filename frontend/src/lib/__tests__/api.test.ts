...
describe('API', () => {
  ...
  describe('getWorkflow', () => {
    ...
    it('should handle workflow not found error', async () => {
      ...
      await expect(apiClient.getWorkflow('invalid-wf')).rejects.toThrow('Workflow not found');
    });
  });
  ...
  describe('getRun', () => {
    ...
    it('should handle run not found error', async () => {
      ...
      await expect(apiClient.getRun('invalid-run')).rejects.toThrow('Run not found');
    });
  });
  ...
  describe('rollbackWorkflow', () => {
    ...
    it('should handle version not found error', async () => {
      ...
      await expect(apiClient.rollbackWorkflow('wf-1', 999)).rejects.toThrow('version not found');
    });
    ...
    it('should handle workflow not found error', async () => {
      ...
      await expect(apiClient.rollbackWorkflow('invalid-wf', 1)).rejects.toThrow('workflow not found');
    });
  });
});
